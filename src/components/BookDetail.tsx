...
export default function BookDetail({ book, initialReviews }: BookDetailProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto text-white px-6 py-8">
      {/* Path */}
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <p className="text-lg text-gray-300">por {book.author}</p>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-3 py-2 border border-white text-white rounded-md text-sm flex items-center gap-1 hover:bg-gray-800"
            >
              📤 Compartir
            </button>
          </div>
          ...
          {/* Añadir a colección */}
          <div className="mt-4">
            <p className="font-semibold">Añadir a colección:</p>
...
<div className="mt-10 flex gap-8">
  ...
  <div className="flex flex-col items-center w-1/4">
    <h2 className="text-5xl font-bold">{average.toFixed(1)}</h2>
    <RatingStars value={average} readOnly />
    <p className="text-gray-400">{total} reseñas</p>
  </div>
